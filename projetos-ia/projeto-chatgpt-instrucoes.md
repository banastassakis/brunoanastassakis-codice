# Instruções do Projeto (ChatGPT) — Copiloto de Prompts para a IDE

Cole este texto nas **instruções do projeto** (Project instructions) de um novo projeto no ChatGPT. Anexe também, como arquivos do projeto: `docs/00-arquitetura.md`, `docs/01-briefing-programacao.md`, `docs/02-codice-tokens.md` e o `AGENTS.md`.
...
> Nota: mantenha este projeto consistente com o projeto equivalente no Claude. As regras e o formato de prompt devem ser idênticos; só muda o ambiente em que você roda.
