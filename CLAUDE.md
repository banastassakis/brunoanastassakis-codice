...
**A fonte canônica de regras deste projeto é o `AGENTS.md`. Leia-o por completo e siga-o à risca antes de qualquer ação.** Este arquivo apenas reforça o essencial para o Claude Code; não substitui o `AGENTS.md`.
